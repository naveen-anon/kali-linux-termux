...
```diff
-; apt update && pkg install wget -y && pkg upgrade -y -o Dpkg::Options::="--force-confnew" && clear && wget -qO install.sh https://github.com/naveen-anon/kali-linux-termux/refs/heads/main/kali_nethunter/install.sh && chmod +x install.sh && bash install.sh
```
